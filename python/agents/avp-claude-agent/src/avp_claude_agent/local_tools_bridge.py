...
def to_sdk_mcp_server(
    ...
    *,
    ...
    tool's async handler when the model invokes it; the AVP translator's
    ...
    the AVP convention; pick a different name only if you've already
    declared a `local` server in `Commission.mcp_servers[]`.
    """
