"""Unit tests for the conformance matcher (`avp.conformance._match`).
...
from avp.conformance._match import _partial, match_case
from avp.conformance.case import EventMatcher, Expectations, FinalState
