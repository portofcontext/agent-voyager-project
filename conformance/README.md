...
```json
{
  ...
  "spec_refs": ["spec/trajectory/v0.1/trajectory.md#3-the-agent-loop-normative"],
  "applies_to": ["agent"],
...
1. Identify a normative requirement in one of the v0.1 specs ([`trajectory.md`](../../spec/trajectory/v0.1/trajectory.md), [`commission.md`](../../spec/commission/v0.1-beta/commission.md), [`agent-descriptor.md`](../../spec/agent-descriptor/v0.1/agent-descriptor.md), [`resolver.md`](../../spec/resolver/v0.1-beta/resolver.md)) that two well-meaning implementers could resolve differently.
...
If a behavior cannot be tested via this format (e.g. cross-cutting transport concerns), add a normative paragraph to the relevant spec (or to the umbrella [`spec/README.md`](../../spec/README.md)) and link the discussion.
