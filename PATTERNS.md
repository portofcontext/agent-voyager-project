...
**What each path adopts.** "Instrument your own loop, Phase 1" is the Released-only path: Trajectory + Agent Descriptor emission, nothing else. Phase 2 and "Wrap an Agent SDK" pull in the experimental Commission + Resolver API for supervisor-driven runs.
