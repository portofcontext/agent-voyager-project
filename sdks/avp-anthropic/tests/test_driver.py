...
def test_cache_read_tokens_count_as_input_per_avp_convention() -> None:
    """AVP §10.4: tokens_input INCLUDES cache-read tokens. The Anthropic SDK
    ...
    # AVP wire: tokens_input = 50 fresh + 400 cache_read = 450
