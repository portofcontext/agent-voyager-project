...
1. **Read the umbrella spec index** at [`../avp/core/spec/v0.1/README.md`](../avp/core/spec/v0.1/README.md) so you know which spec your change touches.
...
└── 0001-avp-to-atif-conversion/       # example future proposal
    ...
    └── metadata.yaml                  # title, authors, status, created, specs touched
```
