...
The wire format is built on CloudEvents 1.0, OTel span identification, MCP,
Agent Skills, and JSON Schema. OpenTelemetry GenAI semantic conventions are a
projection target (`avp.gen_ai`), not on the wire.
